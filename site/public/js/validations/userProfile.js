...
const validationPassword = (expresion, input, campo) => {
  ...
  if (input.value.length === 0) {
    ...
    document.querySelector(`.newPasswordPass`).classList.remove("displayNone");
    document.querySelector(`.newPasswordPass`).classList.add("displayBlock");
    document.querySelector(`.oldPasswordPass`).classList.remove("displayNone");
    ...
    document.querySelector(`.${campo}Caracters`).classList.add("displayBlock");
