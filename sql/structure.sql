...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-09-2022 a las 22:51:41
...
--
ALTER TABLE `venta`
  ADD CONSTRAINT `estado_ibfk_2` FOREIGN KEY (`estado_id`) REFERENCES `venta_estado` (`id`),
